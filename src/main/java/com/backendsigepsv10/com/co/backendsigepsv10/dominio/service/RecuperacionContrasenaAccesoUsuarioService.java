...
public interface RecuperacionContrasenaAccesoUsuarioService {
    ...
    Long contarTotalRegistros(Long idRecuperacionContrasenaAccesoUsuario, String keyword, Long idUsuario, String estadoUsoCodigoActivacionContrasenaAccesoUsuario);
    List<RecuperacionContrasenaAccesoUsuarioDTO> listarRecuperacionesContrasenasAccesosUsuarios(Long idRecuperacionContrasenaAccesoUsuario, String keyword, Long idUsuario, String estadoUsoCodigoActivacionContrasenaAccesoUsuario, String orderBy, String orderMode);
    Slice<RecuperacionContrasenaAccesoUsuarioDTO> listarRecuperacionesContrasenasAccesosUsuariosPag(Pageable pageable, Long idRecuperacionContrasenaAccesoUsuario, String keyword, Long idUsuario, String estadoUsoCodigoActivacionContrasenaAccesoUsuario, String orderBy, String orderMode);
